...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        <div class="indexContent" style="width: 80%;float:left;background-image:url(<%=path%>/static/source/img/chatIng.png)">
            <!-- 聊天区 -->
...
<script>
    ...
    var wsServer = null;
    var ws = null;
    wsServer = "ws://" +"192.168.1.229:8080/"+"${pageContext.request.contextPath}" + "/chatServer";
