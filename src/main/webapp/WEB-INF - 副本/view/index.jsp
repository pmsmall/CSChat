...
<body>
	...
	<div class="am-cf admin-main">
		...
		<div class="admin-content">
			<div class="indexContent"
				style="width: 80%;float:left;background-image:url(<%=path%>/static/source/img/chatIng.png)">
				<!-- 聊天区 -->
				...
				<div class="" style="float: left">
					<p class="am-kai">
						发送给 : <span id="sendto">全体成员</span>
						<button class="am-btn am-btn-xs am-btn-danger"
							onclick="$('#sendto').text('全体成员')">复位</button>
					</p>
				</div>
				<!-- 按钮区 -->
    ...
    var wsServer = null;
    var ws = null;
    wsServer = "ws://" + "192.168.1.229:8080"
    ...
    function showChat(message){
        ...
        var html = "<li class=\"am-comment "+isSef+"privateHere am-comment-primary \" Myttr=\""+message.to+"\"><a href=\"#link-to-user-home\"><img width=\"48\" height=\"48\" class=\"am-comment-avatar\" alt=\"\" src=\"${ctx}/"+message.from+"/head\"></a><div class=\"am-comment-main\">\n" +
    ...
    function tuling(message){
		...
		function addChat(user) {
			...
			for (var i = 0; i < UsersList.length; i++) {
				if (UsersList[i].Myttr == user
						|| UsersList[i].Myttr == '${userid}') {
